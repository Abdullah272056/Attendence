package com.example.attendence.ten_class.ten_class_date;
...
import com.example.attendence.ten_class.Constant10;

import java.util.ArrayList;
import java.util.List;

public class DateDataBaseHelper10 extends SQLiteOpenHelper {
    Context context;
   Constant10 constant;
    public DateDataBaseHelper10(@Nullable Context context ){
        super(context, Constant10.DATE_TABLE_NAME, null, Constant10.DATABASE_Version);
