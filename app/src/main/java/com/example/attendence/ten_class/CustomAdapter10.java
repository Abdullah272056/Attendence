...
public class CustomAdapter10 extends RecyclerView.Adapter<CustomAdapter10.MyViewHolder>{
    ...
    private DataBaseHelper10 databaseHelper;
    ...
    public CustomAdapter10(Context context, List<Notes2> allNotes){
    ...
    @NonNull
    @Override
    public CustomAdapter10.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(context);
        View view= layoutInflater.inflate(R.layout.present_recyclerview_item,parent,false);

        databaseHelper=new DataBaseHelper10(context);
        return new CustomAdapter10.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomAdapter10.MyViewHolder holder, final int position){
                ...
                deleteTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (status == 1){
                            ...
                            alertDialog.dismiss();
                            ((Ten_Class)context).loadStudentInformationData();
