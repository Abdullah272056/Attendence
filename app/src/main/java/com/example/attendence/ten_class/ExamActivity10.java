...
import com.example.attendence.ten_class.ten_exam_date.CustomAdapterTenExamDate;
...
public class ExamActivity10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ThemeDataBaseHelper themeDataBaseHelper=new ThemeDataBaseHelper(ExamActivity10.this);
        ...
        getSupportActionBar().setTitle("<Exam Result> "+classNameList.get(9).getClassName());

        context= ExamActivity10.this;
        // for add back Button in title ba
