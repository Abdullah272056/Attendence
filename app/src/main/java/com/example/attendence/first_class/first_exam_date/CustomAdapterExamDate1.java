package com.example.attendence.first_class.first_exam_date;
...
public class CustomAdapterExamDate1 extends RecyclerView.Adapter<CustomAdapterExamDate1.MyViewHolder> {
    ...
    public CustomAdapterExamDate1(Context context, List<DateNote> allDate) {
        this.context = context;
        this.allDate = allDate;
        dateDataBaseHelper=new DataBaseHelperExamDate1(context);
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate1(context);
        return new CustomAdapterExamDate1.MyViewHolder(view);
    }
