...
public class DataBaseHelperExamDate1 extends SQLiteOpenHelper {
    Context context;
   ConstantExam1 constant;
    public DataBaseHelperExamDate1(@Nullable Context context ){
        super(context, ConstantExam1.DATE_TABLE_NAME, null, ConstantExam1.DATABASE_Version);
