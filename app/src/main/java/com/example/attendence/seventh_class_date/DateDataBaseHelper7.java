package com.example.attendence.seventh_class_date;
...
import com.example.attendence.seventh_class.Constant7;
import com.example.attendence.sixth_class.Constant6;

import java.util.ArrayList;
import java.util.List;

public class DateDataBaseHelper7 extends SQLiteOpenHelper {
    Context context;
   Constant7 constant;
    public DateDataBaseHelper7(@Nullable Context context ){
        super(context, Constant7.DATE_TABLE_NAME, null, Constant7.DATABASE_Version);
