...
public class Notes2 {
    ...
    public Notes2(int checkBox1, int checkBox2, int checkBox3, int checkBox4, int checkBox5,
                  ...
                  int checkBoxCount, String studentName, String examResult1, String examResult2, String examResult3, String examResult4, String examResult5, String examResult6) {
