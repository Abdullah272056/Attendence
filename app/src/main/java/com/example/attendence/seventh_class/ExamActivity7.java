...
import com.example.attendence.seventh_class.seventh_exam_date.CustomAdapterExamDate7;
...
public class ExamActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ThemeDataBaseHelper themeDataBaseHelper=new ThemeDataBaseHelper(ExamActivity7.this);
        ...
        getSupportActionBar().setTitle("<Exam Result>"+classNameList.get(6).getClassName());
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate7(context);
    ...
    private void loadStudentInformationData(){
        ...
        if (studentInformationDataList.size() > 0){
            customAdapter = new ExamCustomAdapter7(context,studentInformationDataList);
    ...
    private void loadDateListData(){
        ...
        if (dateDataList.size() > 0){
            dateCustomAdapter = new CustomAdapterExamDate7(context,dateDataList);
