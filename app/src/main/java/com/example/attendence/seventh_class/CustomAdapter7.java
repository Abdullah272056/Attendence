...
public class CustomAdapter7 extends RecyclerView.Adapter<CustomAdapter7.MyViewHolder>{
    ...
    private DataBaseHelper7 databaseHelper;
    ...
    public CustomAdapter7(Context context, List<Notes2> allNotes){
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomAdapter7.MyViewHolder holder, final int position){
                ...
                deleteTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (status == 1){
                            ...
                            alertDialog.dismiss();
                            ((Seventh_Class)context).loadStudentInformationData();
