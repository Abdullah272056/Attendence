...
public class DataBaseHelperExamDate7 extends SQLiteOpenHelper {
    Context context;
   ConstantExam7 constant;
    public DataBaseHelperExamDate7(@Nullable Context context ){
        super(context, ConstantExam7.DATE_TABLE_NAME, null, ConstantExam7.DATABASE_Version);
