...
public class DateCustomAdapter7 extends RecyclerView.Adapter<DateCustomAdapter7.MyViewHolder> {
    ...
    public DateCustomAdapter7(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DateDataBaseHelper7(context);
        return new DateCustomAdapter7.MyViewHolder(view);
    }
