package com.example.attendence.seventh_class.seventh_exam_date;
...
public class CustomAdapterExamDate7 extends RecyclerView.Adapter<CustomAdapterExamDate7.MyViewHolder> {
    ...
    public CustomAdapterExamDate7(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate7(context);
        return new CustomAdapterExamDate7.MyViewHolder(view);
    }
