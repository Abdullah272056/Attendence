...
public class CustomAdapter8 extends RecyclerView.Adapter<CustomAdapter8.MyViewHolder>{
    ...
    private DataBaseHelper8 databaseHelper;
    ...
    public CustomAdapter8(Context context, List<Notes2> allNotes){
    ...
    @NonNull
    @Override
    public CustomAdapter8.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(context);
        View view= layoutInflater.inflate(R.layout.present_recyclerview_item,parent,false);

        databaseHelper=new DataBaseHelper8(context);
        return new CustomAdapter8.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomAdapter8.MyViewHolder holder, final int position){
                ...
                deleteTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (status == 1){
                            ...
                            alertDialog.dismiss();
                            ((Eight_Class)context).loadStudentInformationData();
                        }else {
                        }
                    }
                });
