...
public class Constant8 {
    public  static final String DATABASE_NAME="Reminder.db8";
    public  static final int DATABASE_Version=1;
    public  static final String TABLE_NAME="MosQueInFormation8";
    public  static final String DATE_TABLE_NAME="DATE8";
