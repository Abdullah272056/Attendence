package com.example.attendence.eight_class.eight_class_date;
...
public class DateCustomAdapter8 extends RecyclerView.Adapter<DateCustomAdapter8.MyViewHolder> {
    ...
    public DateCustomAdapter8(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DateDataBaseHelper8(context);
        return new DateCustomAdapter8.MyViewHolder(view);
    }
