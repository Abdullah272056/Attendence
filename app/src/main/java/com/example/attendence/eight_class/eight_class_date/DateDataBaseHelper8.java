...
public class DateDataBaseHelper8 extends SQLiteOpenHelper {
    Context context;
   Constant8 constant;
    public DateDataBaseHelper8(@Nullable Context context ){
        super(context, Constant8.DATE_TABLE_NAME, null, Constant8.DATABASE_Version);
