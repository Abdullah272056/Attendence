package com.example.attendence.second_exam_date;
...
public class CustomAdapterExamDate2 extends RecyclerView.Adapter<CustomAdapterExamDate2.MyViewHolder> {
    ...
    public CustomAdapterExamDate2(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate2(context);
        return new CustomAdapterExamDate2.MyViewHolder(view);
    }
