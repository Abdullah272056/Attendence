...
public class DataBaseHelperExamDate2 extends SQLiteOpenHelper {
    Context context;
   ConstantExam2 constant;
    public DataBaseHelperExamDate2(@Nullable Context context ){
        super(context, ConstantExam2.DATE_TABLE_NAME, null, ConstantExam2.DATABASE_Version);
