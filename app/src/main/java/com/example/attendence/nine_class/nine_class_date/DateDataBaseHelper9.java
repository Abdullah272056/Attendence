...
public class DateDataBaseHelper9 extends SQLiteOpenHelper {
    Context context;
   Constant9 constant;
    public DateDataBaseHelper9(@Nullable Context context ){
        super(context, Constant9.DATE_TABLE_NAME, null, Constant9.DATABASE_Version);
