...
public class Constant9 {
    public  static final String DATABASE_NAME="Reminder.db9";
    public  static final int DATABASE_Version=1;
    public  static final String TABLE_NAME="MosQueInFormation9";
    public  static final String DATE_TABLE_NAME="DATE9";
