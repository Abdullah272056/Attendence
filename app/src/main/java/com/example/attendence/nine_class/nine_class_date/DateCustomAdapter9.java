package com.example.attendence.nine_class.nine_class_date;
...
public class DateCustomAdapter9 extends RecyclerView.Adapter<DateCustomAdapter9.MyViewHolder> {
    ...
    public DateCustomAdapter9(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DateDataBaseHelper9(context);
        return new DateCustomAdapter9.MyViewHolder(view);
    }
