...
public class CustomAdapter9 extends RecyclerView.Adapter<CustomAdapter9.MyViewHolder>{
    ...
    private DataBaseHelper9 databaseHelper;
    ...
    public CustomAdapter9(Context context, List<Notes2> allNotes){
    ...
    @NonNull
    @Override
    public CustomAdapter9.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater= LayoutInflater.from(context);
        View view= layoutInflater.inflate(R.layout.present_recyclerview_item,parent,false);

        databaseHelper=new DataBaseHelper9(context);
        return new CustomAdapter9.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomAdapter9.MyViewHolder holder, final int position){
                ...
                deleteTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (status == 1){
                            ...
                            alertDialog.dismiss();
                            ((Nine_Class)context).loadStudentInformationData();
                        }else {
                        }
                    }
                });
