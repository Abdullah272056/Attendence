...
import com.example.attendence.test_exam_date.ExamDateCustomAdapter;
import com.example.attendence.test_exam_date.ExamDateDataBaseHelper;
...
public class TestExamActivity extends AppCompatActivity {
    ...
    ExamDateCustomAdapter dateCustomAdapter;
    ...
    private void loadDateListData(){
        ...
        if (dateDataList.size() > 0){
            dateCustomAdapter = new ExamDateCustomAdapter(context,dateDataList);
