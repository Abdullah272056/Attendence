...
import com.example.attendence.fourth_class.fourth_exam_date.CustomAdapterExamDate4;
...
public class ExamActivity4 extends AppCompatActivity {
    ...
    ExamCustomAdapter4 customAdapter;
    Context context;
    Button saveButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ThemeDataBaseHelper themeDataBaseHelper=new ThemeDataBaseHelper(ExamActivity4.this);
        ...
        getSupportActionBar().setTitle("<Exam Result>"+classNameList.get(3).getClassName());

        context=ExamActivity4.this;
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate4(context);
    ...
    private void loadStudentInformationData(){
        ...
        if (studentInformationDataList.size() > 0){
            customAdapter = new ExamCustomAdapter4(context,studentInformationDataList);
    ...
    private void loadDateListData(){
        ...
        if (dateDataList.size() > 0){
            dateCustomAdapter = new CustomAdapterExamDate4(context,dateDataList);
