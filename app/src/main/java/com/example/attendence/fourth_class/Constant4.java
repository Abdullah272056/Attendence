...
public class Constant4 {
    public  static final String DATABASE_NAME="Reminder.db4";
    public  static final int DATABASE_Version=3;
    public  static final String TABLE_NAME="MosQueInFormation4";
    public  static final String DATE_TABLE_NAME="DATE4";
