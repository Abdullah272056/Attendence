package com.example.attendence.fourth_class.fourth_class_date;
...
public class DateCustomAdapter4 extends RecyclerView.Adapter<DateCustomAdapter4.MyViewHolder> {
    ...
    public DateCustomAdapter4(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DateDataBaseHelper4(context);
        return new DateCustomAdapter4.MyViewHolder(view);
    }
