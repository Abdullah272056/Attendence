package com.example.attendence.eight_exam_date;
...
public class CustomAdapterExamDate8 extends RecyclerView.Adapter<CustomAdapterExamDate8.MyViewHolder> {
    ...
    public CustomAdapterExamDate8(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate8(context);
        return new CustomAdapterExamDate8.MyViewHolder(view);
    }
