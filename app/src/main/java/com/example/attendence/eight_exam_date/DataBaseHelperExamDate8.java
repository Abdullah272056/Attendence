...
public class DataBaseHelperExamDate8 extends SQLiteOpenHelper {
    Context context;
   ConstantExam8 constant;
    public DataBaseHelperExamDate8(@Nullable Context context ){
        super(context, ConstantExam8.DATE_TABLE_NAME, null, ConstantExam8.DATABASE_Version);
