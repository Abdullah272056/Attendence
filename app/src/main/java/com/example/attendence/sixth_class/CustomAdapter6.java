...
public class CustomAdapter6 extends RecyclerView.Adapter<CustomAdapter6.MyViewHolder>{
    ...
    private DataBaseHelper6 databaseHelper;
    ...
    public CustomAdapter6(Context context, List<Notes2> allNotes){
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomAdapter6.MyViewHolder holder, final int position){
                ...
                deleteTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (status == 1){
                            ...
                            alertDialog.dismiss();
                            ((Sixth_Class)context).loadStudentInformationData();
