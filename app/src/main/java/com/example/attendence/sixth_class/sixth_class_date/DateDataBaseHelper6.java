package com.example.attendence.sixth_class.sixth_class_date;
...
public class DateDataBaseHelper6 extends SQLiteOpenHelper {
    Context context;
   Constant6 constant;
    public DateDataBaseHelper6(@Nullable Context context ){
        super(context, Constant6.DATE_TABLE_NAME, null, Constant6.DATABASE_Version);
