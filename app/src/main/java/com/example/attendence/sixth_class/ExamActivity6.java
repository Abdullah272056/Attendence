...
import com.example.attendence.sixth_class.sixth_exam_date.CustomAdapterExamDate6;
...
public class ExamActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        getSupportActionBar().setTitle("<Exam Result>"+classNameList.get(5).getClassName());
