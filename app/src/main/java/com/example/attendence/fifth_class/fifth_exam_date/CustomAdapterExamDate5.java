package com.example.attendence.fifth_class.fifth_exam_date;
...
public class CustomAdapterExamDate5 extends RecyclerView.Adapter<CustomAdapterExamDate5.MyViewHolder> {
    ...
    public CustomAdapterExamDate5(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate5(context);
        return new CustomAdapterExamDate5.MyViewHolder(view);
    }
