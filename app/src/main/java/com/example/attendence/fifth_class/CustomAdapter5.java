...
public class CustomAdapter5 extends RecyclerView.Adapter<CustomAdapter5.MyViewHolder>{
    ...
    private DataBaseHelper5 databaseHelper;
    ...
    public CustomAdapter5(Context context, List<Notes2> allNotes){
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomAdapter5.MyViewHolder holder, final int position){
                ...
                deleteTextView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (status == 1){
                            ...
                            alertDialog.dismiss();
                            ((Fifth_Class)context).loadStudentInformationData();
