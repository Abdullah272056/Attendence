...
public class DateDataBaseHelper5 extends SQLiteOpenHelper {
    Context context;
   Constant5 constant;
    public DateDataBaseHelper5(@Nullable Context context ){
        super(context, Constant5.DATE_TABLE_NAME, null, Constant5.DATABASE_Version);
