...
public class DataBaseHelperExamDate5 extends SQLiteOpenHelper {
    Context context;
   ConstantExam5 constant;
    public DataBaseHelperExamDate5(@Nullable Context context ){
        super(context, ConstantExam5.DATE_TABLE_NAME, null, ConstantExam5.DATABASE_Version);
