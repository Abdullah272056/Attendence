package com.example.attendence.fifth_class.fifth_class_date;
...
public class DateCustomAdapter5 extends RecyclerView.Adapter<DateCustomAdapter5.MyViewHolder> {
    ...
    public DateCustomAdapter5(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DateDataBaseHelper5(context);
        return new DateCustomAdapter5.MyViewHolder(view);
    }
