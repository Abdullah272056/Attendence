package com.example.attendence.third_class.third_class_date;
...
public class DateDataBaseHelper3 extends SQLiteOpenHelper {
    Context context;
   Constant3 constant;
    public DateDataBaseHelper3(@Nullable Context context ){
        super(context, Constant3.DATE_TABLE_NAME, null, Constant3.DATABASE_Version);
