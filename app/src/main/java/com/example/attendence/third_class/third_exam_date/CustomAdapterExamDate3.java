package com.example.attendence.third_class.third_exam_date;
...
public class CustomAdapterExamDate3 extends RecyclerView.Adapter<CustomAdapterExamDate3.MyViewHolder> {
    ...
    public CustomAdapterExamDate3(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate3(context);
        return new CustomAdapterExamDate3.MyViewHolder(view);
    }
