...
import com.example.attendence.third_class.third_exam_date.CustomAdapterExamDate3;
...
public class ExamActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ThemeDataBaseHelper themeDataBaseHelper=new ThemeDataBaseHelper(ExamActivity3.this);
        ...
        getSupportActionBar().setTitle("<Exam Result>"+classNameList.get(2).getClassName());
