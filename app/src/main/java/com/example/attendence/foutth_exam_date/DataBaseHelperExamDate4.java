...
public class DataBaseHelperExamDate4 extends SQLiteOpenHelper {
    Context context;
   ConstantExam4 constant;
    public DataBaseHelperExamDate4(@Nullable Context context ){
        super(context, ConstantExam4.DATE_TABLE_NAME, null, ConstantExam4.DATABASE_Version);
