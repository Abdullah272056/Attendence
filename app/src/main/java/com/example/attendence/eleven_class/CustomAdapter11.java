...
public class CustomAdapter11 extends RecyclerView.Adapter<CustomAdapter11.MyViewHolder>{
    ...
    public CustomAdapter11(Context context, List<Notes2> allNotes){
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomAdapter11.MyViewHolder holder, final int position){
