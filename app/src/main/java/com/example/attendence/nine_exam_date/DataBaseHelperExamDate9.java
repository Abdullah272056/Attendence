...
public class DataBaseHelperExamDate9 extends SQLiteOpenHelper {
    Context context;
   ConstantExam9 constant;
    public DataBaseHelperExamDate9(@Nullable Context context ){
        super(context, ConstantExam9.DATE_TABLE_NAME, null, ConstantExam9.DATABASE_Version);
