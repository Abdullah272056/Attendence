...
public class DataBaseHelperExamDate6 extends SQLiteOpenHelper {
    Context context;
   ConstantExam6 constant;
    public DataBaseHelperExamDate6(@Nullable Context context ){
        super(context, ConstantExam6.DATE_TABLE_NAME, null, ConstantExam6.DATABASE_Version);
