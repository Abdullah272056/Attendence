package com.example.attendence.sixth_exam_date;
...
public class CustomAdapterExamDate6 extends RecyclerView.Adapter<CustomAdapterExamDate6.MyViewHolder> {
    ...
    public CustomAdapterExamDate6(Context context, List<DateNote> allDate) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        dateDataBaseHelper=new DataBaseHelperExamDate6(context);
        return new CustomAdapterExamDate6.MyViewHolder(view);
    }
